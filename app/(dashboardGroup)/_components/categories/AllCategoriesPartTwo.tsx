...
import { Mail, MapPin, Maximize, Phone, User, Wifi } from 'lucide-react';
const AllCategoriesPartTwo = ({ categories }:{categories: CategoryWithProperties[]}) => {
  return (
                ...
                >
                  <CardHeader className="bg-muted/30 pb-4">
                    ...
                    <div className="flex items-baseline gap-1 mt-2 text-2xl font-bold tracking-tight">
                      <span className="text-xl font-semibold text-emerald-600 mr-0.5">
                        TK{" "}
                      </span>
                  ...
                  <CardContent className="space-y-5 pt-4 text-sm flex flex-col flex-1">
                    ...
                    <div className="flex items-center text-muted-foreground">
                      ...
                      <span>
                        Area Size: <strong>{property.areaInSqFt} Sq Ft</strong>
                      </span>
                    </div>
...
export default AllCategoriesPartTwo